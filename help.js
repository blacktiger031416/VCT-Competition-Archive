  ...
  var HELP_CONFIG = {
    ...
    prediction: {
      ...
      items: [
        ...
        { sel: ".vault-display",
          title: "금고",
          desc: "시즌이 종료될 때마다 그 시즌에 모은 코인이 금고에 누적 보관됩니다." },
        { sel: "#attend-card",
          title: "출석 체크",
    ...
    stage_group: {
      ...
      items: [
        { sel: ".group-assign-section, .group-assign-grid",
          ...
          desc: "각 조의 팀을 보여줍니다." },
        { sel: ".ch-invite-grid",
          title: "Challengers 초청 팀",
          desc: "각 권역 Challengers 리그에서 초청된 팀들입니다. Stage 2에 한해 그룹 스테이지에 합류합니다." },
        { sel: ".week-section, .week-panels",
          title: "주차별 경기",
          desc: "각 주차별 경기를 보여줍니다." },
        { sel: "a.playin-link",
          title: "Play-In",
          desc: "그룹 스테이지 후 진행되는 Play-In 대진표로 이동합니다." },
        { sel: "a.playoff-link",
          title: "PlayOff",
    ...
    stage: {
      ...
      items: [
        ...
        { sel: ".match-block, .match-cell, .series-row, .result-row, article.bracket-match, .bracket-match",
          title: "경기 결과",
          desc: "클릭하면 상세 경기 결과를 볼 수 있습니다." },
        { sel: ".bracket-wrap, .bracket-cell, .bracket-grid, .bracket-scroll",
          title: "대진표",
    ...
    match_dark: {
      title: "경기 상세 도움말",
      items: [
        { multiSel: ".mo-header, .mo-results",
          title: "경기 결과",
          desc: "경기 팀과 라운드 승리를 보여줍니다." },
        { sel: ".mo-prediction",
          title: "시청자 승부 예측",
          desc: "시청자 예측을 보여줍니다. (기준: vlr.gg)" },
        { sel: ".mo-veto",
          title: "맵 밴픽",
          desc: "서로의 맵 밴픽을 보여줍니다." },
        { multiSel: ".map-scoreboard, .player-table",
          title: "라운드 결과 & 선수 스탯",
          desc: "각 팀의 라운드 승리와 선수들의 ACS, K/D, 사용 요원을 보여줍니다." },
        { sel: ".team-stats-wrap",
          title: "팀 스탯",
          desc: "각 팀의 스탯인 스코어, 첫킬, 절약왕, 포스트 플랜트, 클러치를 보여줍니다." },
      ],
    },
  };
